...
class SubnetManagerTester:
    ...
    def test_del(self):
        ...
        self.run_test("add 10.20.0.0/16\ndel 10.20.0.0/16", "Deleting existing subnet", "Deleting 10.20.0.0/16", "0\n0")
        self.report += "\n"
    ...
    def test_check(self):
        ...
        self.run_test("add 10.20.0.0/16\nadd 32.64.128.0/20\ncheck 10.20.128.10\ncheck 32.64.140.200\ncheck 192.168.1.1", "Checking IP address", "Adding 10.20.0.0/16", "0\n0\n16\n20\n-1")
        self.report += "\n"
